...
<footer>
	<div class="container footer-grid">
		<div class="footer-col">
			...
			<p style="margin-top: 20px; color: var(--text-muted); font-size: 0.9rem;">
				Connecting the best talent with the best companies.
			</p>
		</div>
		...
		<div class="footer-col">
			<h4>Subscribe</h4>
			<p style="color: var(--text-muted); font-size: 0.9rem; margin-bottom: 16px;">Get the latest job updates.
			</p>
	...
	<div class="container footer-bottom">
		<p>© 2026 Simple Tech Groups. All rights reserved.</p>
